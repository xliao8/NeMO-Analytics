...
When you first open the Expression Viewer, a default gene will appear, but you can replace it by typing any other gene name into the search box. By default, the viewer shows one gene at a time. However, after saving your own gene list in NeMO (covered in a later section), you will be able to view multiple genes and toggle between them.
